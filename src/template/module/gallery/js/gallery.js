while (document.readyState !== "complete") setTimeout(() => {console.log(document.readyState)}, 100);
...
function displayImages(nrOfImages, caption=imageCaptions()) {
  ...
  for (let currentImage=0; currentImage<nrOfImages; currentImage++) {
    images += constructGalleryImage(currentImage, nrOfImages, `/src/img/bg${currentImage}.jpg`, caption[currentImage]);
  }
